...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("s_axis_video_TDATA", 64, hls_in, 0, "axis", "in_data", 1),
	Port_Property("s_axis_video_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("s_axis_video_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("s_axis_video_TKEEP", 8, hls_in, 1, "axis", "in_data", 1),
	Port_Property("s_axis_video_TSTRB", 8, hls_in, 2, "axis", "in_data", 1),

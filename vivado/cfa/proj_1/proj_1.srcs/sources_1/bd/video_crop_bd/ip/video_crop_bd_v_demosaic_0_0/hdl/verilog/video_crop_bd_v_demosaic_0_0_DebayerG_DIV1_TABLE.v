...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module video_crop_bd_v_demosaic_0_0_DebayerG_DIV1_TABLE_rom (
...
initial begin
    $readmemh("./video_crop_bd_v_demosaic_0_0_DebayerG_DIV1_TABLE_rom.dat", ram0);
    $readmemh("./video_crop_bd_v_demosaic_0_0_DebayerG_DIV1_TABLE_rom.dat", ram1);
    $readmemh("./video_crop_bd_v_demosaic_0_0_DebayerG_DIV1_TABLE_rom.dat", ram2);
    $readmemh("./video_crop_bd_v_demosaic_0_0_DebayerG_DIV1_TABLE_rom.dat", ram3);
end
...
`timescale 1 ns / 1 ps
module video_crop_bd_v_demosaic_0_0_DebayerG_DIV1_TABLE(
    reset,
    clk,
    address0,
    ce0,
...
video_crop_bd_v_demosaic_0_0_DebayerG_DIV1_TABLE_rom video_crop_bd_v_demosaic_0_0_DebayerG_DIV1_TABLE_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

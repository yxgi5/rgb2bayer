...
(* CORE_GENERATION_INFO = "video_crop_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=video_crop_bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "video_crop_bd.hwdef" *) 
module video_crop_bd
  ...
  wire [11:0]axi_vip_1_M_AXI_ARADDR;
  wire axi_vip_1_M_AXI_ARREADY;
  wire axi_vip_1_M_AXI_ARVALID;
  wire [11:0]axi_vip_1_M_AXI_AWADDR;
  ...
  wire [0:0]axis_subset_converter_0_M_AXIS_TSTRB;
  ...
  wire [0:0]rgb2bayer_0_m_axis_video_TKEEP;
  wire [0:0]rgb2bayer_0_m_axis_video_TLAST;
  wire rgb2bayer_0_m_axis_video_TREADY;
  wire [0:0]rgb2bayer_0_m_axis_video_TSTRB;
  ...
  video_crop_bd_axi_vip_1_0 axi_vip_1
       (.aclk(aclk_0_1),
        .aresetn(aresetn_0_1),
  ...
  video_crop_bd_axis_subset_converter_0_0 axis_subset_converter_0
       (.aclk(aclk_0_1),
        .aresetn(aresetn_0_1),
        ...
        .s_axis_tdata(rgb2bayer_0_m_axis_video_TDATA),
        .s_axis_tdest(rgb2bayer_0_m_axis_video_TDEST),
        .s_axis_tid(rgb2bayer_0_m_axis_video_TID),
        .s_axis_tkeep(rgb2bayer_0_m_axis_video_TKEEP),
        .s_axis_tlast(rgb2bayer_0_m_axis_video_TLAST),
        .s_axis_tready(rgb2bayer_0_m_axis_video_TREADY),
        .s_axis_tstrb(rgb2bayer_0_m_axis_video_TSTRB),
        .s_axis_tuser(rgb2bayer_0_m_axis_video_TUSER),
        .s_axis_tvalid(rgb2bayer_0_m_axis_video_TVALID));
  video_crop_bd_rgb2bayer_0_0 rgb2bayer_0
       (.ap_clk(aclk_0_1),
        ...
        .m_axis_video_TID(rgb2bayer_0_m_axis_video_TID),
        .m_axis_video_TKEEP(rgb2bayer_0_m_axis_video_TKEEP),
        .m_axis_video_TLAST(rgb2bayer_0_m_axis_video_TLAST),
        .m_axis_video_TREADY(rgb2bayer_0_m_axis_video_TREADY),
        .m_axis_video_TSTRB(rgb2bayer_0_m_axis_video_TSTRB),
  ...
  video_crop_bd_v_demosaic_0_0 v_demosaic_0
       (.ap_clk(aclk_0_1),
        .ap_rst_n(aresetn_0_1),
        ...
        .s_axi_CTRL_ARADDR(axi_vip_1_M_AXI_ARADDR[5:0]),
        .s_axi_CTRL_ARREADY(axi_vip_1_M_AXI_ARREADY),
        .s_axi_CTRL_ARVALID(axi_vip_1_M_AXI_ARVALID),
        .s_axi_CTRL_AWADDR(axi_vip_1_M_AXI_AWADDR[5:0]),
        .s_axi_CTRL_AWREADY(axi_vip_1_M_AXI_AWREADY),
        .s_axi_CTRL_AWVALID(axi_vip_1_M_AXI_AWVALID),
        .s_axi_CTRL_BREADY(axi_vip_1_M_AXI_BREADY),
        .s_axi_CTRL_BRESP(axi_vip_1_M_AXI_BRESP),
        .s_axi_CTRL_BVALID(axi_vip_1_M_AXI_BVALID),
        .s_axi_CTRL_RDATA(axi_vip_1_M_AXI_RDATA),
        .s_axi_CTRL_RREADY(axi_vip_1_M_AXI_RREADY),
        .s_axi_CTRL_RRESP(axi_vip_1_M_AXI_RRESP),
        .s_axi_CTRL_RVALID(axi_vip_1_M_AXI_RVALID),
        .s_axi_CTRL_WDATA(axi_vip_1_M_AXI_WDATA),
        .s_axi_CTRL_WREADY(axi_vip_1_M_AXI_WREADY),
        .s_axi_CTRL_WSTRB(axi_vip_1_M_AXI_WSTRB),
        .s_axi_CTRL_WVALID(axi_vip_1_M_AXI_WVALID),

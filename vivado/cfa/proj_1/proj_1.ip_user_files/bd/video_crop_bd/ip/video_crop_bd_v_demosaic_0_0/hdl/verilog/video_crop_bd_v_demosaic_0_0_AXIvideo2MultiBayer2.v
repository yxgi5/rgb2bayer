...
module video_crop_bd_v_demosaic_0_0_AXIvideo2MultiBayer2 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
wire   [0:0] exitcond3_i_i_i_i_fu_349_p2;
wire   [0:0] brmerge_i_i_i_i_fu_363_p2;
wire    ap_CS_fsm_state9;
wire   [0:0] ap_phi_mux_eol_2_i_i_i_i_phi_fu_292_p4;
reg    imgBayer_V_val_0_V_blk_n;
reg    ap_enable_reg_pp1_iter1;
reg   [0:0] exitcond3_i_i_i_i_reg_423;
reg    HwReg_bayer_phase_c_blk_n;
wire    ap_CS_fsm_state2;
reg   [0:0] eol_reg_194;
reg   [7:0] axi_data_V_1_i_i_i_i_reg_205;
reg   [0:0] eol_i_i_i_i_reg_216;
reg   [11:0] j_i_i_i_i_reg_228;
reg   [0:0] axi_last_V_2_i_i_i_i_reg_239;
reg   [7:0] p_Val2_s_reg_252;
reg    ap_block_state1;
wire   [11:0] grp_reg_unsigned_short_s_fu_317_ap_return;
reg   [11:0] tmp_i_i_i_i_reg_384;
wire    grp_reg_unsigned_short_s_fu_317_ap_ready;
wire    grp_reg_unsigned_short_s_fu_317_ap_done;
wire    grp_reg_unsigned_short_s_fu_323_ap_ready;
wire    grp_reg_unsigned_short_s_fu_323_ap_done;
reg    ap_block_state2_on_subcall_done;
wire   [11:0] grp_reg_unsigned_short_s_fu_323_ap_return;
reg   [11:0] tmp_i_i_i_i_125_reg_389;
reg   [7:0] tmp_data_V_reg_394;
reg   [0:0] tmp_last_V_reg_402;
wire   [0:0] exitcond_i_i_i_i_fu_338_p2;
wire    ap_CS_fsm_state5;
wire   [11:0] i_fu_343_p2;
reg   [11:0] i_reg_418;
reg    ap_predicate_op123_read_state6;
reg    ap_block_state6_pp1_stage0_iter0;
reg    ap_block_state7_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [11:0] j_fu_354_p2;
reg    ap_block_state9;
reg    ap_block_pp1_stage0_subdone;
reg    ap_condition_pp1_exit_iter0_state6;
wire    grp_reg_unsigned_short_s_fu_317_ap_start;
wire    grp_reg_unsigned_short_s_fu_317_ap_idle;
wire   [11:0] grp_reg_unsigned_short_s_fu_317_in_r;
wire    grp_reg_unsigned_short_s_fu_323_ap_start;
wire    grp_reg_unsigned_short_s_fu_323_ap_idle;
wire   [11:0] grp_reg_unsigned_short_s_fu_323_in_r;
reg   [0:0] axi_last_V_3_i_i_i_i_reg_265;
reg   [0:0] axi_last_V1_i_i_i_i_reg_163;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state4;
reg   [7:0] axi_data_V_3_i_i_i_i_reg_277;
reg   [7:0] axi_data_V1_i_i_i_i_reg_173;
reg   [11:0] i_i_i_i_i_reg_183;
reg   [0:0] ap_phi_mux_eol_phi_fu_197_p4;
reg   [7:0] ap_phi_mux_axi_data_V_1_i_i_i_i_phi_fu_208_p4;
reg   [0:0] ap_phi_mux_eol_i_i_i_i_phi_fu_220_p4;
wire   [0:0] ap_phi_reg_pp1_iter0_axi_last_V_2_i_i_i_i_reg_239;
wire   [7:0] ap_phi_reg_pp1_iter0_p_Val2_s_reg_252;
wire    ap_CS_fsm_state8;
reg   [0:0] eol_2_i_i_i_i_reg_289;
reg    grp_reg_unsigned_short_s_fu_317_ap_start_reg;
reg    ap_block_state1_ignore_call72;
reg    grp_reg_unsigned_short_s_fu_323_ap_start_reg;
reg    ap_block_state1_ignore_call73;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_i_i_i_i_fu_108;
wire   [0:0] tmp_user_V_fu_329_p1;
reg   [8:0] ap_NS_fsm;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
...
#0 grp_reg_unsigned_short_s_fu_317_ap_start_reg = 1'b0;
#0 grp_reg_unsigned_short_s_fu_323_ap_start_reg = 1'b0;
end

video_crop_bd_v_demosaic_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_317(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_reg_unsigned_short_s_fu_317_ap_start),
    .ap_done(grp_reg_unsigned_short_s_fu_317_ap_done),
    .ap_idle(grp_reg_unsigned_short_s_fu_317_ap_idle),
    .ap_ready(grp_reg_unsigned_short_s_fu_317_ap_ready),
    .in_r(grp_reg_unsigned_short_s_fu_317_in_r),
    .ap_return(grp_reg_unsigned_short_s_fu_317_ap_return)
);

video_crop_bd_v_demosaic_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_323(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_reg_unsigned_short_s_fu_323_ap_start),
    .ap_done(grp_reg_unsigned_short_s_fu_323_ap_done),
    .ap_idle(grp_reg_unsigned_short_s_fu_323_ap_idle),
    .ap_ready(grp_reg_unsigned_short_s_fu_323_ap_ready),
    .in_r(grp_reg_unsigned_short_s_fu_323_in_r),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond_i_i_i_i_fu_338_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state6) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond_i_i_i_i_fu_338_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_reg_unsigned_short_s_fu_317_ap_start_reg <= 1'b0;
    end else begin
        if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_reg_unsigned_short_s_fu_317_ap_start_reg <= 1'b1;
        end else if ((grp_reg_unsigned_short_s_fu_317_ap_ready == 1'b1)) begin
            grp_reg_unsigned_short_s_fu_317_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_reg_unsigned_short_s_fu_323_ap_start_reg <= 1'b0;
    end else begin
        if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_reg_unsigned_short_s_fu_323_ap_start_reg <= 1'b1;
        end else if ((grp_reg_unsigned_short_s_fu_323_ap_ready == 1'b1)) begin
            grp_reg_unsigned_short_s_fu_323_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        axi_data_V1_i_i_i_i_reg_173 <= tmp_data_V_reg_394;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        axi_data_V1_i_i_i_i_reg_173 <= axi_data_V_3_i_i_i_i_reg_277;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond3_i_i_i_i_reg_423 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        axi_data_V_1_i_i_i_i_reg_205 <= p_Val2_s_reg_252;
    end else if (((exitcond_i_i_i_i_fu_338_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        axi_data_V_1_i_i_i_i_reg_205 <= axi_data_V1_i_i_i_i_reg_173;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        axi_data_V_3_i_i_i_i_reg_277 <= axi_data_V_1_i_i_i_i_reg_205;
    end else if ((~((eol_2_i_i_i_i_reg_289 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0)) & (eol_2_i_i_i_i_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
        axi_data_V_3_i_i_i_i_reg_277 <= s_axis_video_V_data_V_0_data_out;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        axi_last_V1_i_i_i_i_reg_163 <= tmp_last_V_reg_402;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        axi_last_V1_i_i_i_i_reg_163 <= axi_last_V_3_i_i_i_i_reg_265;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_583)) begin
        if (((brmerge_i_i_i_i_fu_363_p2 == 1'd1) & (exitcond3_i_i_i_i_fu_349_p2 == 1'd0))) begin
            axi_last_V_2_i_i_i_i_reg_239 <= ap_phi_mux_eol_phi_fu_197_p4;
        end else if (((brmerge_i_i_i_i_fu_363_p2 == 1'd0) & (exitcond3_i_i_i_i_fu_349_p2 == 1'd0))) begin
            axi_last_V_2_i_i_i_i_reg_239 <= s_axis_video_V_last_V_0_data_out;
        end else if ((1'b1 == 1'b1)) begin
            axi_last_V_2_i_i_i_i_reg_239 <= ap_phi_reg_pp1_iter0_axi_last_V_2_i_i_i_i_reg_239;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        axi_last_V_3_i_i_i_i_reg_265 <= eol_reg_194;
    end else if ((~((eol_2_i_i_i_i_reg_289 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0)) & (eol_2_i_i_i_i_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
        axi_last_V_3_i_i_i_i_reg_265 <= s_axis_video_V_last_V_0_data_out;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        eol_2_i_i_i_i_reg_289 <= eol_i_i_i_i_reg_216;
    end else if ((~((eol_2_i_i_i_i_reg_289 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0)) & (eol_2_i_i_i_i_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
        eol_2_i_i_i_i_reg_289 <= s_axis_video_V_last_V_0_data_out;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond3_i_i_i_i_reg_423 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        eol_i_i_i_i_reg_216 <= axi_last_V_2_i_i_i_i_reg_239;
    end else if (((exitcond_i_i_i_i_fu_338_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        eol_i_i_i_i_reg_216 <= 1'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond3_i_i_i_i_reg_423 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        eol_reg_194 <= axi_last_V_2_i_i_i_i_reg_239;
    end else if (((exitcond_i_i_i_i_fu_338_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        eol_reg_194 <= axi_last_V1_i_i_i_i_reg_163;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        i_i_i_i_i_reg_183 <= 12'd0;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        i_i_i_i_i_reg_183 <= i_reg_418;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond3_i_i_i_i_fu_349_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        j_i_i_i_i_reg_228 <= j_fu_354_p2;
    end else if (((exitcond_i_i_i_i_fu_338_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        j_i_i_i_i_reg_228 <= 12'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_583)) begin
        if (((brmerge_i_i_i_i_fu_363_p2 == 1'd1) & (exitcond3_i_i_i_i_fu_349_p2 == 1'd0))) begin
            p_Val2_s_reg_252 <= ap_phi_mux_axi_data_V_1_i_i_i_i_phi_fu_208_p4;
        end else if (((brmerge_i_i_i_i_fu_363_p2 == 1'd0) & (exitcond3_i_i_i_i_fu_349_p2 == 1'd0))) begin
            p_Val2_s_reg_252 <= s_axis_video_V_data_V_0_data_out;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond3_i_i_i_i_fu_349_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_i_i_i_i_fu_108 <= 1'd0;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        sof_1_i_i_i_i_fu_108 <= 1'd1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        exitcond3_i_i_i_i_reg_423 <= exitcond3_i_i_i_i_fu_349_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        i_reg_418 <= i_fu_343_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((s_axis_video_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        tmp_data_V_reg_394 <= s_axis_video_V_data_V_0_data_out;
        tmp_last_V_reg_402 <= s_axis_video_V_last_V_0_data_out;
    end
end

always @ (posedge ap_clk) begin
    if ((~((1'b0 == HwReg_bayer_phase_c_full_n) | (1'b1 == ap_block_state2_on_subcall_done)) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_i_i_i_i_125_reg_389 <= grp_reg_unsigned_short_s_fu_323_ap_return;
        tmp_i_i_i_i_reg_384 <= grp_reg_unsigned_short_s_fu_317_ap_return;
    end
end
...
always @ (*) begin
    if ((exitcond3_i_i_i_i_fu_349_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond_i_i_i_i_fu_338_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((exitcond3_i_i_i_i_reg_423 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_axi_data_V_1_i_i_i_i_phi_fu_208_p4 = p_Val2_s_reg_252;
    end else begin
        ap_phi_mux_axi_data_V_1_i_i_i_i_phi_fu_208_p4 = axi_data_V_1_i_i_i_i_reg_205;
    end
end

always @ (*) begin
    if (((exitcond3_i_i_i_i_reg_423 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_eol_i_i_i_i_phi_fu_220_p4 = axi_last_V_2_i_i_i_i_reg_239;
    end else begin
        ap_phi_mux_eol_i_i_i_i_phi_fu_220_p4 = eol_i_i_i_i_reg_216;
    end
end

always @ (*) begin
    if (((exitcond3_i_i_i_i_reg_423 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_eol_phi_fu_197_p4 = axi_last_V_2_i_i_i_i_reg_239;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | ((eol_2_i_i_i_i_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state9)) | ((brmerge_i_i_i_i_fu_363_p2 == 1'd0) & (exitcond3_i_i_i_i_fu_349_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if (((~((eol_2_i_i_i_i_reg_289 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0)) & (eol_2_i_i_i_i_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state9)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_predicate_op123_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((s_axis_video_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state3)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((tmp_user_V_fu_329_p1 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else if (((tmp_user_V_fu_329_p1 == 1'd1) & (s_axis_video_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((exitcond3_i_i_i_i_fu_349_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((exitcond3_i_i_i_i_fu_349_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        ...
        ap_ST_fsm_state9 : begin
            if ((~((eol_2_i_i_i_i_reg_289 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0)) & (eol_2_i_i_i_i_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end else if ((~((eol_2_i_i_i_i_reg_289 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0)) & (ap_phi_mux_eol_2_i_i_i_i_phi_fu_292_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((exitcond3_i_i_i_i_reg_423 == 1'd0) & (imgBayer_V_val_0_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op123_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((exitcond3_i_i_i_i_reg_423 == 1'd0) & (imgBayer_V_val_0_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op123_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((exitcond3_i_i_i_i_reg_423 == 1'd0) & (imgBayer_V_val_0_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op123_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state1_ignore_call72 = ((real_start == 1'b0) | (ap_done_reg == 1'b1));
end
...
always @ (*) begin
    ap_block_state2_on_subcall_done = ((grp_reg_unsigned_short_s_fu_323_ap_done == 1'b0) | (grp_reg_unsigned_short_s_fu_317_ap_done == 1'b0));
end

always @ (*) begin
    ap_block_state6_pp1_stage0_iter0 = ((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op123_read_state6 == 1'b1));
end

always @ (*) begin
    ap_block_state7_pp1_stage0_iter1 = ((exitcond3_i_i_i_i_reg_423 == 1'd0) & (imgBayer_V_val_0_V_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state9 = ((eol_2_i_i_i_i_reg_289 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0));
end
...
assign ap_phi_mux_eol_2_i_i_i_i_phi_fu_292_p4 = eol_2_i_i_i_i_reg_289;

assign ap_phi_reg_pp1_iter0_axi_last_V_2_i_i_i_i_reg_239 = 'bx;

assign ap_phi_reg_pp1_iter0_p_Val2_s_reg_252 = 'bx;

always @ (*) begin
    ap_predicate_op123_read_state6 = ((brmerge_i_i_i_i_fu_363_p2 == 1'd0) & (exitcond3_i_i_i_i_fu_349_p2 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_i_i_i_i_fu_363_p2 = (sof_1_i_i_i_i_fu_108 | ap_phi_mux_eol_i_i_i_i_phi_fu_220_p4);

assign exitcond3_i_i_i_i_fu_349_p2 = ((j_i_i_i_i_reg_228 == tmp_i_i_i_i_125_reg_389) ? 1'b1 : 1'b0);

assign exitcond_i_i_i_i_fu_338_p2 = ((i_i_i_i_i_reg_183 == tmp_i_i_i_i_reg_384) ? 1'b1 : 1'b0);

assign grp_reg_unsigned_short_s_fu_317_ap_start = grp_reg_unsigned_short_s_fu_317_ap_start_reg;

assign grp_reg_unsigned_short_s_fu_317_in_r = HwReg_height[11:0];

assign grp_reg_unsigned_short_s_fu_323_ap_start = grp_reg_unsigned_short_s_fu_323_ap_start_reg;

assign grp_reg_unsigned_short_s_fu_323_in_r = HwReg_width[11:0];

assign i_fu_343_p2 = (i_i_i_i_i_reg_183 + 12'd1);

assign imgBayer_V_val_0_V_din = p_Val2_s_reg_252;

assign j_fu_354_p2 = (j_i_i_i_i_reg_228 + 12'd1);
...
assign tmp_user_V_fu_329_p1 = s_axis_video_V_user_V_0_data_out;

endmodule //video_crop_bd_v_demosaic_0_0_AXIvideo2MultiBayer2

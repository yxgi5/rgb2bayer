...
HD_PWD='/home/andreas/workdir/figkey/HLS/repo/rgb2bayer/vivado/cfa/proj_1/proj_1.runs/video_crop_bd_axis_subset_converter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_crop_bd_axis_subset_converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_crop_bd_axis_subset_converter_0_0.tcl

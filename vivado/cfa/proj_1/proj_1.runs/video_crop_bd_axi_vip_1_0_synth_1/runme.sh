...
HD_PWD='/home/andreas/workdir/figkey/HLS/repo/loop_repo/vivado/cfa/proj_1/proj_1.runs/video_crop_bd_axi_vip_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_crop_bd_axi_vip_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_crop_bd_axi_vip_1_0.tcl

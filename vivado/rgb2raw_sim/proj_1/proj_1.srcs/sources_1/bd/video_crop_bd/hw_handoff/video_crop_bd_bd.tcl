...
proc create_root_design { parentCell } {
  ...
  set tdata [ create_bd_port -dir O -from 15 -to 0 tdata ]
  ...
  connect_bd_net -net rgb2bayer_0_m_axis_video_TLAST [get_bd_ports tlast] [get_bd_pins rgb2bayer_0/m_axis_video_TLAST]
  connect_bd_net -net rgb2bayer_0_m_axis_video_TUSER [get_bd_ports tuser] [get_bd_pins rgb2bayer_0/m_axis_video_TUSER]
  connect_bd_net -net rgb2bayer_0_m_axis_video_TVALID [get_bd_ports tvalid] [get_bd_pins rgb2bayer_0/m_axis_video_TVALID]
  connect_bd_net -net tready_1 [get_bd_ports tready] [get_bd_pins rgb2bayer_0/m_axis_video_TREADY]

...
`timescale 1 ns / 1 ps
module video_crop_bd_v_tpg_0_0_tpgPatternRainbow_tpgSinTableArray_9bi(
    reset,
    clk,
    address0,
    ce0,
...
video_crop_bd_v_tpg_0_0_tpgPatternRainbow_tpgSinTableArray_9bi_rom video_crop_bd_v_tpg_0_0_tpgPatternRainbow_tpgSinTableArray_9bi_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
